    ...
    return (
        <section className="flex flex-col items-center justify-center h-auto w-auto xxs:text-xs text-center">
            <div className=' xxs:justify-center items-center'>
                <h1 className="shadow-2xl- md:text-3xl pt-10 text-white xxs:text-lg">Cyber Sakura  </h1>
                <p className="px-3 mt-2 uppercase lg:text-lg mb-8 text-gray-400 sm:text-xs">
                Thriving in Digital Tranquility: Cyber Sakura, Your Security Oasis. 
                </p>
