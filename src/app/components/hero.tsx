...
const Hero = () => {
    ...
    return ( 
        <section className="flex flex-col items-center justify-center">
            <div>
                <h1 className="shadow-2xl text-white pt-10 xs:text-6xl xxs:text-3xl">Cyber Sakura  </h1>
                <p className="px-3 mt-2 max-w-4xl lg:text-lg mb-8 text-gray-400 md:text-base xxs:text-sm sm:text-sm">
            ...
            <div className="flex items-center justify-center lg:p-12 sm:p-4 xs:max-w-none xxs:max-w-xs mt-3">
