    ...
    return (
        <section className="flex flex-col items-center justify-center h-auto w-auto xxs:text-xs text-center">
            <div className=' xxs:justify-center items-center'>
                ...
                <p className="bg-white rounded-full p-3 mt-2 uppercase lg:text-lg mb-8 text-gray-400 sm:text-xs">
                    Cyber Sakura, Your Security Oasis. 
                </p>
                <div className="flex flex-wrap justify-center space-x-4">
                    <button className="lg:text-lg bg-gray-800 hover:bg-gray-700 text-white px-3 py-2 rounded-md mb-3 sm:text-xs">
                        Join us
                    </button>
                    <button className="lg:text-lg bg-gray-800 hover:bg-gray-700 text-white px-3 py-2 rounded-md text-center mb-3 sm:text-xs">
                        Request Demo
                    </button>
                </div>
            </div>
