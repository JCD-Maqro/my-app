...
const MoreBlog = () => {
    return(
        <section className="m-12 xxs:m-3 flex flex-col justify-items-center items-center">
            ...
            <p className="md:max-w-md sm:max-w-sm xs:max-w-xs text-center text-base m-2 text-white">Stay up to date with the latest trends, insights, and advancements in cybersecurity with our blog section.</p>
